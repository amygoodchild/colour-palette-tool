...
export default function PaletteDrawer({view, isClosing, onClose, onColorChange, currentColorHSB}){
  ...
  return (
    <div className={cl}>
      ...
      <ColorPicker onColorChange={handleColorChange} currentColorHSB={currentColorHSB} />
    </div>
  )
} 
